...
import React, { FC, memo, useRef, useEffect, useState, ReactNode } from "react";
...
const button = cva(
  "flex items-center justify-center gap-3 cursor-pointer transition relative overflow-hidden",
  {
    variants: {
      variant: {
        default: "text-white",
    ...
    >
      {isLoading && (
        <SpinnerLoading
          ...
          padding={4}
          color={
            variant === "border" || variant === "light" ? undefined : "#fff"
          }
        />
      )}
